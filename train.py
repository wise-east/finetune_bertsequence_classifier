...
def get_data_loaders(args, tokenizer):
    ...
    train_masks, validation_masks, train_segments, validation_segments = train_test_split(attention_masks, segment_ids, random_state=2018, test_size=args.test_size)
